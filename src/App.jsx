...
const App = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const emailSubject = "Naba Beats Booking Inquiry";
    const emailBody = `Name: ${formData.name}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nService: ${formData.service}\n\nProject Details:\n${formData.details}`;
    window.location.href = `mailto:nababeats@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
    setFormStatus("Opening email client to send your message...");
  };
  ...
  const services = [
    {
      ...
      title: "01 — FULL PRODUCTION",
      desc: "From idea to release-ready record. Custom beat, arrangement, and full creative direction.\n\nIncludes: Beat • Recording • Mix & Master",
      price: "NRs 30,000"
    },
    {
      icon: <Sliders className="w-8 h-8 text-orange-500" />,
      title: "02 — MIXING & MASTERING",
      desc: "Clean, powerful, industry-standard sound optimized for streaming.\n\nIncludes: Stem Mix • Master • Final Polish",
      price: "NRs 10,000"
    },
    {
      icon: <Mic2 className="w-8 h-8 text-orange-500" />,
      title: "03 — VOCAL RECORDING",
      desc: "Professional vocal tracking with modern processing and pitch correction.",
      price: "NRs 8,000"
    }
  ];
      ...
      <section id="services" className="py-24 bg-zinc-900/50 border-y border-zinc-800">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              <div key={idx} className="p-8 bg-zinc-950 rounded-3xl border border-zinc-800 hover:shadow-orange-500/5 transition-all">
                ...
                <p className="text-zinc-500 mb-8 leading-relaxed whitespace-pre-line">{service.desc}</p>
          ...
          <div className="mt-16 max-w-3xl mx-auto text-center">
            <p className="text-orange-400 uppercase tracking-[0.3em] font-bold mb-3">BOOK A SESSION</p>
            <p className="text-zinc-400 mb-8">Limited slots available.</p>
            <a href="#contact" className="inline-flex items-center justify-center bg-orange-600 hover:bg-orange-700 text-black font-bold px-10 py-4 rounded-full transition-all">
              Book Now
            </a>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-zinc-400 text-lg leading-relaxed mb-6">
                I help artists turn raw ideas into records that sound ready for the world. As a producer and engineer, I work across Pop, Hip-Hop, Soulful, and Classic sounds—bringing both precision and feel. 
              </p>
              <p className="text-zinc-400 text-lg leading-relaxed mb-8">
                My goal is simple: make music that truly connects artists with their listeners.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-zinc-950 rounded-[3rem] p-8 md:p-16 shadow-2xl">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 focus:border-orange-500 outline-none transition-all"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-zinc-500 uppercase mb-2">Phone Number</label>
                  <input
                    type="tel"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 focus:border-orange-500 outline-none transition-all"
                  >
                    <option>01 — FULL PRODUCTION</option>
                    <option>02 — MIXING & MASTERING</option>
                    <option>03 — VOCAL RECORDING</option>
              ...
              <div className="sr-only">
                ...
                <input
                  ...
                  onChange={(e) => handleFormChange("botField", e.target.value)}
                  autoComplete="off"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 focus:border-orange-500 outline-none transition-all"
                  placeholder="Tell me about your vibe, deadline, and reference tracks..."
                  required
                ></textarea>
              </div>

              {formStatus && <p className="text-sm text-orange-400">{formStatus}</p>}
